...
public class Simulation extends Engine {
     ...
     */
    public Simulation(Controller controller, int servicePointsCount, int customersCount, Distributions dist, double mean, double variance) {
        super();
        ...
        switch (dist) {
            case Normal:
                spDist = new Normal(mean, variance);
